...
> python main.py --puzzle puzzle_b --face_search beeline_search --piece_search sequential_search --puzzle_memory_loss .5 --puzzle_memory_loss_counter_limit 5 --csv stats.csv
